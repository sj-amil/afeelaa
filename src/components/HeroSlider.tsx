          ...
          <div className="max-w-4xl">
            ...
            >
              <Link
                ...
                style={{ background: 'linear-gradient(135deg, #5D8A3A 0%, #6FA446 100%)', color: 'white' }}
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="group bg-white/10 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/20 hover:bg-white/20 hover:scale-105 transition-all duration-300 hover:shadow-2xl active:scale-95"
                >
                  <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-emerald-300 to-green-200 bg-clip-text text-transparent mb-1 sm:mb-2">
                    {stat.value}
                  </div>
